...
Query_file = '~/DP_out_Sum/Murder/Grubbs/MGQueries.csv'
Queries = pd.read_csv(Query_file, 'rt', delimiter=',' , engine = 'python')
Store_file = 'MGBFS-e2.dat'
...
#print '\n The final Queue is \n', Queue   
#print '\n The final Queue is \n', Queue     
print '\n The GBFS runtime, starting from org_ctx and choosing randomly one among childern in each layer is \n', runtime
