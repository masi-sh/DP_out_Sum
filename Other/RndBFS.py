...
Org_Vec  = np.zeros(len(FirAtt_lst)+len(SecAtt_lst)+len(ThrAtt_lst)).tolist()
temp_Vec = np.zeros(len(FirAtt_lst)+len(SecAtt_lst)+len(ThrAtt_lst)).tolist()
...
Org_Vec.extend(temp_Vec[0:len(SecAtt_lst)])
